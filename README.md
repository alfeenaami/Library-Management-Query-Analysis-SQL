...
## Overview  
Designing and analyzing a relational database to streamline library operations — managing books, members, and loans while generating insights such as overdue tracking, borrow frequency, and member activity analysis.
